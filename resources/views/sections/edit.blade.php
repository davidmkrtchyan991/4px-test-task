...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('pages.edit.section') }}</div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                               placeholder="" value="{{$section->name}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description" class="form-control"
                                               placeholder="" value="{{$section->description}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        @foreach ($users as $value)
                                            <p>
                                                <input type="checkbox" name="users[]" value="{{ $value->id }}"
                                                       id="{{ $value->id }}"  {{in_array($value->id, $section_user) ? 'checked="checked"' : ''}}>
                                                <label for="{{ $value->id }}">
                                                    {{ $value->name }}
